...
// Too Many Types (TMT) ROM hack species data - replaces standard gen 9
// Only contains the 301 Pokemon available in TMT
const SV: {[name: string]: SpeciesData} = {
  ...
  'Rattata': {
    types: ['Boring'],
    bs: {hp:30, at:56, df:35, sp:72, sa:25, sd:35},
    weightkg: 3.5,
    nfe: true,
    abilities: {0: 'Run Away'},
  ...
  'Raticate': {
    types: ['Boring'],
    bs: {hp:55, at:81, df:60, sp:97, sa:50, sd:70},
    weightkg: 18.5,
    abilities: {0: 'Run Away'},
  ...
  'Krabby': {
    types: ['Crab'],
    bs: {hp:30, at:105, df:90, sp:50, sa:25, sd:25},
    weightkg: 6.5,
    nfe: true,
    abilities: {0: 'Hyper Cutter'},
  },
  'Kingler': {
    types: ['Crab'],
    bs: {hp:55, at:130, df:115, sp:75, sa:50, sd:50},
    weightkg: 60,
    abilities: {0: 'Hyper Cutter'},
  ...
  'Pikachu': {
    types: ['Pikachu'],
    bs: {hp:35, at:55, df:40, sp:90, sa:50, sd:50},
    weightkg: 6,
    nfe: true,
    abilities: {0: 'Static'},
  ...
  'Raichu': {
    ...
    bs: {hp:60, at:90, df:55, sp:110, sa:90, sd:80},
    weightkg: 30,
    abilities: {0: 'Static'},
  ...
  'Chansey': {
    types: ['Friend'],
    bs: {hp:250, at:5, df:5, sp:50, sa:35, sd:105},
    weightkg: 34.6,
    gender: 'F',
    nfe: true,
    abilities: {0: 'Natural Cure'},
  ...
  'Vulpix': {
    types: ['Fire','Fluffy'],
    bs: {hp:38, at:41, df:40, sp:65, sa:50, sd:65},
    weightkg: 9.9,
    nfe: true,
    abilities: {0: 'Flash Fire'},
  ...
  'Ninetales': {
    ...
    bs: {hp:73, at:76, df:75, sp:100, sa:81, sd:100},
    weightkg: 19.9,
    abilities: {0: 'Flash Fire'},
  ...
  'Magikarp': {
    types: ['Water','Ugly'],
    bs: {hp:20, at:10, df:55, sp:80, sa:15, sd:20},
    weightkg: 10,
    nfe: true,
    abilities: {0: 'Swift Swim'},
  },
  'Gyarados': {
    types: ['Water','Angy'],
    bs: {hp:95, at:125, df:79, sp:81, sa:60, sd:100},
    weightkg: 235,
    abilities: {0: 'Intimidate'},
  ...
  'Geodude': {
    ...
    bs: {hp:40, at:80, df:100, sp:20, sa:30, sd:30},
    weightkg: 20,
    nfe: true,
    abilities: {0: 'Rock Head'},
  ...
  'Graveler': {
    types: ['Crab','Rock'],
    bs: {hp:55, at:95, df:115, sp:35, sa:45, sd:45},
    weightkg: 105,
    nfe: true,
    abilities: {0: 'Rock Head'},
  ...
  'Golem': {
    types: ['Boring','Ugly','Rock'],
    bs: {hp:80, at:120, df:130, sp:45, sa:55, sd:65},
    weightkg: 300,
    abilities: {0: 'Rock Head'},
  ...
  'Mankey': {
    types: ['Monke','Angy'],
    bs: {hp:40, at:80, df:35, sp:70, sa:35, sd:45},
    weightkg: 28,
    nfe: true,
    abilities: {0: 'Vital Spirit'},
  },
  'Primeape': {
    types: ['Monke','Angy'],
    bs: {hp:65, at:105, df:60, sp:95, sa:60, sd:70},
    weightkg: 32,
    nfe: true,
    abilities: {0: 'Vital Spirit'},
  },
  ...
  'Sandshrew': {
    types: ['Ground','Friend'],
    bs: {hp:50, at:75, df:85, sp:40, sa:20, sd:30},
    weightkg: 12,
    nfe: true,
    abilities: {0: 'Sand Veil'},
  ...
  'Sandslash': {
    types: ['Ground','Sharp'],
    bs: {hp:75, at:100, df:110, sp:65, sa:45, sd:55},
    weightkg: 29.5,
    abilities: {0: 'Sand Veil'},
  ...
  'Mr. Mime': {
    types: ['Silly','Psychic'],
    bs: {hp:40, at:45, df:65, sp:90, sa:100, sd:120},
    weightkg: 54.5,
    abilities: {0: 'Soundproof'},
    otherFormes: ["Mr. Mime-Galar"],
  },
  'Mr. Rime': {
    types: ['Silly','Ice','Boomer'],
    bs: {hp:80, at:85, df:75, sa:110, sd:100, sp:70},
    weightkg: 58.2,
    abilities: {0: 'Tangled Feet'},
  },
  ...
  'Slowpoke': {
    types: ['Water','Vibe'],
    bs: {hp:90, at:65, df:65, sp:15, sa:40, sd:40},
    weightkg: 36,
    nfe: true,
    abilities: {0: 'Oblivious'},
  ...
  'Slowbro': {
    types: ['Water','Vibe'],
    bs: {hp:95, at:75, df:110, sp:30, sa:100, sd:80},
    weightkg: 78.5,
    abilities: {0: 'Oblivious'},
    otherFormes: ["Slowbro-Galar","Slowbro-Mega"],
  },
  'Slowking': {
  ...
  'Growlithe': {
    types: ['Fire','Friend'],
    bs: {hp:55, at:70, df:45, sp:60, sa:70, sd:50},
    weightkg: 19,
    nfe: true,
    abilities: {0: 'Intimidate'},
  ...
  'Arcanine': {
    types: ['Fire','Friend'],
    bs: {hp:90, at:110, df:80, sp:95, sa:100, sd:80},
    weightkg: 155,
    abilities: {0: 'Intimidate'},
  ...
  'Doduo': {
    ...
    bs: {hp:35, at:85, df:45, sp:75, sa:35, sd:35},
    weightkg: 39.2,
    nfe: true,
    abilities: {0: 'Run Away'},
  },
  'Dodrio': {
    types: ['Normal','Flying','Guys'],
    bs: {hp:60, at:110, df:70, sp:110, sa:60, sd:60},
    weightkg: 85.2,
    abilities: {0: 'Run Away'},
  },
  'Eevee': {
    types: ['Normal','Fluffy'],
    bs: {hp:55, at:55, df:50, sp:55, sa:45, sd:65},
    weightkg: 6.5,
    nfe: true,
    abilities: {0: 'Run Away'},
    otherFormes: ["Eevee-Gmax"],
  },
  'Vaporeon': {
    types: ['Water','Liquid','Furry'],
    bs: {hp:130, at:65, df:60, sp:65, sa:110, sd:95},
    weightkg: 29,
    abilities: {0: 'Water Absorb'},
  },
  'Jolteon': {
    types: ['Electric','Sharp'],
    bs: {hp:65, at:65, df:60, sp:130, sa:110, sd:95},
    weightkg: 24.5,
    abilities: {0: 'Volt Absorb'},
  },
  'Flareon': {
    types: ['Fire','Fluffy'],
    bs: {hp:65, at:130, df:60, sp:65, sa:95, sd:110},
    weightkg: 25,
    abilities: {0: 'Flash Fire'},
  },
  'Espeon': {
  ...
  'Magmar': {
    types: ['Fire','Zoomer'],
    bs: {hp:65, at:95, df:57, sp:93, sa:100, sd:85},
    weightkg: 44.5,
    nfe: true,
    abilities: {0: 'Flame Body'},
  },
  ...
  'Machop': {
    ...
    bs: {hp:70, at:80, df:50, sp:35, sa:35, sd:35},
    weightkg: 19.5,
    nfe: true,
    abilities: {0: 'Guts'},
  },
  'Machoke': {
    types: ['Fighting','Stinky'],
    bs: {hp:80, at:100, df:70, sp:45, sa:50, sd:60},
    weightkg: 70.5,
    nfe: true,
    abilities: {0: 'Guts'},
  },
  'Machamp': {
    types: ['Fighting','Crab'],
    bs: {hp:90, at:130, df:80, sp:55, sa:65, sd:85},
    weightkg: 130,
    abilities: {0: 'Guts'},
  ...
  'Diglett': {
    types: ['Smash'],
    bs: {hp:10, at:55, df:25, sp:95, sa:35, sd:45},
    weightkg: 0.8,
    nfe: true,
    abilities: {0: 'Sand Veil'},
  ...
  'Dugtrio': {
    types: ['Smash','Guys'],
    bs: {hp:35, at:100, df:50, sp:120, sa:50, sd:70},
    weightkg: 33.3,
    abilities: {0: 'Sand Veil'},
  ...
  'Koffing': {
    types: ['Poison','Stinky'],
    bs: {hp:40, at:65, df:95, sp:35, sa:60, sd:45},
    weightkg: 1,
    nfe: true,
    abilities: {0: 'Levitate'},
  },
  'Weezing': {
    ...
    bs: {hp:65, at:90, df:120, sp:60, sa:85, sd:70},
    weightkg: 9.5,
    abilities: {0: 'Levitate'},
  ...
  'Grimer': {
    types: ['Liquid','Poison'],
    bs: {hp:80, at:80, df:50, sp:25, sa:40, sd:50},
    weightkg: 30,
    nfe: true,
    abilities: {0: 'Stench'},
  ...
  'Muk': {
    types: ['Liquid','Poison'],
    bs: {hp:105, at:105, df:75, sp:50, sa:65, sd:100},
    weightkg: 30,
    abilities: {0: 'Stench'},
  ...
  'Electabuzz': {
    types: ['Electric','Zoomer'],
    bs: {hp:65, at:83, df:57, sp:105, sa:95, sd:85},
    weightkg: 30,
    nfe: true,
    abilities: {0: 'Static'},
  },
  ...
  'Porygon': {
    types: ['Prime','Gamer'],
    bs: {hp:65, at:60, df:70, sp:40, sa:85, sd:75},
    weightkg: 36.5,
    gender: 'N',
    nfe: true,
    abilities: {0: 'Trace'},
  ...
  'Clefairy': {
    types: ['Space','Fairy'],
    bs: {hp:70, at:45, df:48, sp:35, sa:60, sd:65},
    weightkg: 7.5,
    nfe: true,
    abilities: {0: 'Cute Charm'},
  },
  'Clefable': {
    types: ['Space','Fairy'],
    bs: {hp:95, at:70, df:73, sp:60, sa:95, sd:90},
    weightkg: 40,
    abilities: {0: 'Cute Charm'},
  ...
  'Lickitung': {
    types: ['Right','Sus'],
    bs: {hp:90, at:55, df:75, sp:30, sa:60, sd:75},
    weightkg: 65.5,
    nfe: true,
    abilities: {0: 'Own Tempo'},
  },
  ...
  'Voltorb': {
    types: ['Angy','Ball'],
    bs: {hp:40, at:30, df:50, sp:100, sa:55, sd:55},
    weightkg: 10.4,
    gender: 'N',
    nfe: true,
    abilities: {0: 'Soundproof'},
  ...
  'Electrode': {
    ...
    bs: {hp:60, at:50, df:70, sp:150, sa:80, sd:80},
    weightkg: 66.6,
    gender: 'N',
    abilities: {0: 'Soundproof'},
  ...
  'Hitmonlee': {
    types: ['Fighting','Left'],
    bs: {hp:50, at:120, df:53, sp:87, sa:35, sd:110},
    weightkg: 49.8,
    gender: 'M',
    abilities: {0: 'Limber'},
  },
  'Hitmonchan': {
    ...
    bs: {hp:50, at:105, df:79, sp:76, sa:35, sd:110},
    weightkg: 50.2,
    gender: 'M',
    abilities: {0: 'Keen Eye'},
  },
  ...
  'Lapras': {
    ...
    bs: {hp:130, at:85, df:80, sp:60, sa:85, sd:95},
    weightkg: 220,
    abilities: {0: 'Water Absorb'},
  ...
  'Horsea': {
    types: ['Water','Gun'],
    bs: {hp:30, at:40, df:70, sp:60, sa:70, sd:25},
    weightkg: 8,
    nfe: true,
    abilities: {0: 'Swift Swim'},
  },
  'Seadra': {
    types: ['Water','Gun'],
    bs: {hp:55, at:65, df:95, sp:85, sa:95, sd:45},
    weightkg: 25,
    nfe: true,
    abilities: {0: 'Poison Point'},
  },
  ...
  'Venonat': {
    ...
    bs: {hp:60, at:55, df:50, sp:45, sa:40, sd:55},
    weightkg: 30,
    nfe: true,
    abilities: {0: 'Compound Eyes'},
  },
  'Venomoth': {
    ...
    bs: {hp:70, at:65, df:60, sp:90, sa:90, sd:75},
    weightkg: 12.5,
    abilities: {0: 'Shield Dust'},
  },
  'Zangoose': {
  ...
  'Kangaskhan': {
    types: ['Normal','Guys'],
    bs: {hp:105, at:95, df:80, sp:90, sa:40, sd:80},
    weightkg: 80,
    gender: 'F',
    abilities: {0: 'Early Bird'},
  ...
  'Ditto': {
    types: ['Sus','Liquid'],
    bs: {hp:48, at:48, df:48, sp:48, sa:48, sd:48},
    weightkg: 4,
    gender: 'N',
    abilities: {0: 'Limber'},
  },
  ...
  'Drowzee': {
    types: ['Dream'],
    bs: {hp:60, at:48, df:45, sp:42, sa:43, sd:90},
    weightkg: 32.4,
    nfe: true,
    abilities: {0: 'Insomnia'},
  },
  'Hypno': {
    types: ['Right','Boomer'],
    bs: {hp:85, at:73, df:70, sp:67, sa:73, sd:115},
    weightkg: 75.6,
    abilities: {0: 'Insomnia'},
  },
  'Duskull': {
  ...
  'Zubat': {
    ...
    bs: {hp:40, at:45, df:35, sp:55, sa:30, sd:40},
    weightkg: 7.5,
    nfe: true,
    abilities: {0: 'Inner Focus'},
  },
  'Golbat': {
    types: ['Boring','Poison','Flying'],
    bs: {hp:75, at:80, df:70, sp:90, sa:65, sd:75},
    weightkg: 55,
    nfe: true,
    abilities: {0: 'Inner Focus'},
  },
  'Crobat': {
    types: ['Flying','Poison','Friend'],
    bs: {hp:85, at:90, df:80, sa:70, sd:80, sp:130},
    weightkg: 75,
    abilities: {0: 'Inner Focus'},
  },
  ...
  'Snorlax': {
    types: ['Ohio','Friend'],
    bs: {hp:160, at:110, df:65, sp:30, sa:65, sd:110},
    weightkg: 460,
    abilities: {0: 'Immunity'},
  ...
  'Mew': {
    types: ['Prime'],
    bs: {hp:100, at:100, df:100, sp:100, sa:100, sd:100},
    weightkg: 4,
    gender: 'N',
    abilities: {0: 'Synchronize'},
  },
